...
/*   Updated: 2022/11/21 15:23:27 by kshim            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_init_mutex_and_philo(t_prg *prg, t_sveil *surveil)
{
	...
	if (surveil -> philo_num == 1)
		ft_set_philo_only_one(prg -> philo_arr, prg -> last_eat_arr,
...
void	ft_set_philo_only_one(t_philo *philo_arr, pthread_mutex_t *last_eat_arr,
